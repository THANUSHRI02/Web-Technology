...
<body>
    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center"><a href="#"><h2 class="text-primary">TSK CAKE SHOP</h2></a><span class="splash-description">Please enter your user information.</span></div>
            <div class="card-body">
            ...
            <div class="card-footer bg-white p-0  "><center>
                <div class="card-footer-item card-footer-item-bordered">
                    <a href="admin_signup.php" class="footer-link">Create An Account</a></div></center>
                </div>
            </div>
        </div>
    </div>
